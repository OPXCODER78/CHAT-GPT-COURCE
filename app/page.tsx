...
export default function Page() {
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <nav className="flex items-center justify-between px-8 py-6 border-b border-purple-500/30 backdrop-blur-md bg-black/80 rounded-[36px]">
                <div className="flex items-center">
                    <div className="text-2xl font-bold bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent">
                        PRAKHAR
                    </div>
                    <div className="text-2xl font-bold bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent ml-2">
                        ACADEMY
                    </div>
                </div>
                <div className="hidden md:flex items-center space-x-8 text-sm">
                    <a
                        href="#"
                        className="px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full text-white font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg shadow-purple-500/30 bg-[#000000AF] bg-contain bg-center bg-repeat"
                    >
                        CHATGPT COURSE
                    </a>
                </div>
                <button className="px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 rounded-full text-white font-semibold hover:from-green-600 hover:to-green-700 transition-all duration-300 shadow-lg shadow-green-500/30">
                    Login
                </button>
            </nav>
            <section className="relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-purple-900/70 via-purple-800/60 to-blue-900/70"></div>
                <div className="relative flex flex-col lg:flex-row items-center px-6 py-16 max-w-7xl mx-auto">
                    <div className="lg:w-1/2 space-y-6">
                        ...
                        <div className="bg-black/50 p-4 rounded-lg border border-gray-700">
                            <div className="text-red-400 font-bold mb-2">NEW 2025 UPDATES:</div>
                        ...
                        <div className="flex flex-wrap items-center gap-6 text-sm">
                            <div className="flex items-center space-x-3 bg-gradient-to-r from-red-500/20 to-red-600/20 px-4 py-2 rounded-full border border-red-500/30">
                            ...
                            <div className="flex items-center space-x-3 bg-gradient-to-r from-blue-500/20 to-blue-600/20 px-4 py-2 rounded-full border border-blue-500/30">
                            ...
                            <div className="flex items-center space-x-3 bg-gradient-to-r from-purple-500/20 to-purple-600/20 px-4 py-2 rounded-full border border-purple-500/30">
                        ...
                        <button className="w-full lg:w-auto bg-gradient-to-r from-green-500 via-green-600 to-emerald-600 hover:from-green-600 hover:via-green-700 hover:to-emerald-700 px-12 py-5 font-bold text-xl text-white shadow-2xl shadow-green-500/40 hover:shadow-green-500/60 transform hover:scale-105 transition-all duration-300 rounded-[48px]">
                             Join Now
                        </button>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-gray-400">
                                    Happy Learners on PRAKHAR Academy
                                </div>
                            </div>
                            <div className="ml-8">
                                <div className="flex items-center space-x-1">
                                    <span className="font-bold">4.7★</span>
                                    <span className="text-sm text-gray-400">(1500+ Ratings)</span>
                                </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="w-96 h-96 relative">
                                <img
                                    ...
                                    alt="Instructor"
                                    className="object-cover w-[413px] h-[435px]"
                                />
                            </div>
                            {/* Glowing AI Symbol */}
                            <div className="absolute bottom-8 right-8 w-32 h-32">
                                ...
                                <div
                                    className="absolute -bottom-2 -right-2 w-3 h-3 bg-blue-400 rounded-full opacity-60 animate-bounce"
